...
from adaptive_memory.core.exceptions import ClusterNotFoundError
from adaptive_memory.core.logging import get_logger
from adaptive_memory.storage.metadata_store.base import BaseMetadataStore, TopicCluster
from adaptive_memory.storage.vector_store.base import BaseVectorStore
...
class TopicClusterStore:
    ...
    async def find_nearest_clusters_batch(
        ...
        cluster_map: dict[uuid.UUID, TopicCluster | None] = {}
        if unique_ids:
    ...
    async def split_cluster(self, cluster_id: uuid.UUID) -> list[TopicCluster]:
        ...
        sub_clusters: list[TopicCluster] = []
