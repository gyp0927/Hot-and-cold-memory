...
from adaptive_memory.core.config import Tier, get_settings
from adaptive_memory.core.exceptions import ChunkNotFoundError, MigrationError
from adaptive_memory.core.logging import get_logger
from adaptive_memory.ingestion.embedder import Embedder
from adaptive_memory.monitoring.metrics import MIGRATION_DURATION, MIGRATION_TOTAL
from adaptive_memory.storage.metadata_store.base import (
    BaseMetadataStore,
    MemoryItem,
    MigrationLog,
)
from adaptive_memory.tiers.base import MemoryEntry, RetrievedMemory
...
class MigrationEngine:
    ...
    async def _persist_hot_to_cold(
        ...
        try:
            ...
            from adaptive_memory.storage.metadata_store.base import MemoryItem
            now = datetime.utcnow()
