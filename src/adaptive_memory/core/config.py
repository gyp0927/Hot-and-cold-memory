...
class Settings(BaseSettings):
    ...
    VECTOR_DB_COLLECTION: str = "adaptive_memory"
    ...
    # Metadata Database
    METADATA_DB_URL: str = "postgresql+asyncpg://memory:memory_password@localhost:5432/adaptive_memory"
